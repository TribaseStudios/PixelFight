...
function Update ()
{
	...
	{
		if(Input.GetAxis("Player2Move") > 0 && !swappingSkin)
		{
			swappingSkin = true;
		...
		else if(Input.GetAxis("Player2Move") < 0 && !swappingSkin)
		{
			swappingSkin = true;
			if(currentChoice > 0)
			{
		...
		else if(Input.GetAxis("Player2Move") == 0)
		{
			swappingSkin = false;
		}
